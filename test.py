...
steps = [
    ...
    # {"step": "Stop backend process on remote server", "command": lambda: cli.make_directory("cams")},
    # {"step": "Transfer files to remote server", "command": lambda: cli.transfer_files(local_path="dist",destination_path="/root/prod/cams")},
